...
export default function QuestionText({ phrase, speed = 30, className = '' }: QuestionTextProps) {
  ...
  return (
    <motion.div
      className={`font-mono md:text-3xl text-2xl font-bold text-black dark:text-white flex items-center ${className}`}
    ...
    >
      ...
      {/* blinking cursor */}
      <motion.span
        className="border-r-2 border-black dark:border-white ml-1"
