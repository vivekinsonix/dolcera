...
export default function PartnerAdvisoryCouncil() {
  return (
    <section id="teams" className="relative overflow-hidden py-24">
      ...
      <div className="absolute -right-40 top-0 -z-10 h-[600px] w-[900px] rounded-full bg-gradient-to-br from-primary-50 via-white to-secondary-200 opacity-90 blur-3xl" />
      ...
      <div className="relative  text-center mx-auto container px-4 ">
        ...
        <h1 className="mb-16 text-3xl font-extrabold leading-tight   md:text-5xl">Our Team</h1>
