...
export default function Policy() {
  ...
  const seoDescription =
    'Read Insonix Privacy Policy to learn how we collect, use, and safeguard your information when using our services.';
  const seoKeywords = 'Insonix, Privacy Policy, Data Protection, GDPR';
  const seoUrl = `${process.env.NEXT_PUBLIC_BASE_URL || 'https://insonix.com'}/privacypolicy`;
    ...
    <>
      ...
      >
        <main className="container mx-auto max-w-full px-4 mt-16">
          <header className="py-8 text-left mx-auto container">
            <h1 id="privacy-policy-heading" className="max-w-3xl text-3xl leading-tight font-bold md:text-5xl">
              Privacy Policy
            </h1>
          </header>
              ...
              <section className="container mx-auto max-w-full  prose dark:prose-invert  prose-headings:mt-0 ">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    protect the rights and property of Insonix.
                  </li>
                </ul>

                <h2 className="text-2xl my-2">3. Legal Bases for Processing (EEA/UK users)</h2>
                <p>
                ...
                <address>
                  ...
                  <br /> Email: <Link href="mailto:info@insonix.com">info@insonix.com</Link>
                  <br /> Address: Insonix
                </address>
