  ...
  return (
    ...
    >
      <div className="space-y-4 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
        <p>
          We take the security of our systems seriously and appreciate the efforts of security researchers and users who
          help us keep our platform safe.
        </p>

        <p>
          If you believe you have discovered a security vulnerability in our website or services, please report it
          responsibly.
        </p>
