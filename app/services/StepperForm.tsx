    ...
    <div className="max-w-xl mx-auto  bg-transparent   rounded-lg ">
            ...
            <div className="block gap-3  mb-2 mt-5">
              <div className="flex gap-6 justify-center items-center py-8">
                <Card
                  ...
                  className={`w-40 cursor-pointer hover:shadow-lg transition-all ${answer === 'yes' ? 'border-2 border-green-500 bg-green-50' : 'border border-gray-200'}`}
                >
                ...
                <Card
                  ...
                  className={`w-40 cursor-pointer hover:shadow-lg transition-all ${answer === 'no' ? 'border-2 border-red-500 bg-red-50' : 'border border-gray-200'}`}
                >
                  <div className="flex flex-col items-center gap-2">
      ...
      <div className="flex justify-between mt-6">
        ...
        {currentStep < steps.length - 1 ? (
          ...
          <Button
            type="button"
            className="bg-blue-100 border-0 text-black hover:scale-105 focus:border-0 rounded-full uppercase"
