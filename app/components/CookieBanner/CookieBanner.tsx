      ...
      <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        ...
        <div className="md:max-w-3xl">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            By clicking <strong>“Accept All”</strong>, you agree to the storing of cookies on your device to enhance
            site navigation, analyse site usage, and personalise content.
          </p>
