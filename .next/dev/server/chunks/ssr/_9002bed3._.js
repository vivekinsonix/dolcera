...
"[project]/app/(pages)/blogs/BlogList.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BlogList() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchCategories = async ()=>{
            ...
            try {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$blogService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBlogsCategories"])();
                const cats = res?.data || [];
                setCategories(cats);
                // Cache in memory
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const fetchBlogs = async ()=>{
            ...
            try {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$blogService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBlogs"])({
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: !loading && blogs.length > 0 ? blogs.map((post)=>{
                        ...
                        return(// <article key={post.id} className="rounded-xl border-0 dark:bg-secondary-dark p-0 shadow-xl transition-transform duration-300 hover:scale-105" aria-labelledby={`blog-title-${post.id}`}>
                        //   <figure>
                        //     <Image src={img} alt={post.title || 'Blog Cover Image'} width={600} height={400} className="h-48 w-full object-cover rounded-t-xl" loading="lazy" />
                        //   </figure>
                        //   <div className="p-4">
                        //     <header>
                        //       <h2 id={`blog-title-${post.id}`} className="mb-4 text-2xl font-bold">
                        //         <Link href={`/blogs/detail/${post.slug}`} className="hover:underline">
                        //           {post.title}
                        //         </Link>
                        //       </h2>
                        //     </header>
                        ...
                        //       <span>{post.author || 'Insonix Team'}</span>
                        //     </div>
                        //     <footer>
                        //       <Link href={`/blogs/detail/${post.slug}`} className="text-blue-500 hover:text-blue-700 hover:underline" aria-label={`Read more about ${post.title}`}>
                        //         Read More →
                        //       </Link>
                        //     </footer>
                        //   </div>
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                            className: "group relative w-full dark:bg-primary bg-white aspect-[1/1] overflow-hidden rounded-sm shadow-xl",
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "cursor-pointer absolute bottom-0 left-0 right-0 bg-gradient-to-t from-white via-white to-secondary/90 dark:from-secondary-dark/95 dark:via-secondary-dark/95 dark:to-secondary-dark/90 dark:text-white backdrop-blur-md   rounded-t-sm         h-[180px]   overflow-hidden   px-5 py-4   opacity-100   translate-y-0      /* HOVER → FULL EXPAND FROM BOTTOM TO TOP */   group-hover:h-99   group-hover:px-7 group-hover:py-10   group-hover:opacity-100      transition-all duration-[500ms] ease-linear   ",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: " mb-2   text-sm opacity-80   transition-all duration-[500ms] ease-linear   ",
                                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$utility$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatDate"])(post?.createdAt)
                                        }, void 0, false, {
                                            fileName: "[project]/app/(pages)/blogs/BlogList.tsx",
                                            lineNumber: 194,
                                            columnNumber: 21
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                                            ...
                                            className: "   mt-4 block dark:text-primary-100 text-primary-200 font-semibold   opacity-0 group-hover:opacity-100   transition-opacity duration-[500ms] ease-linear   ",
                                            children: "Read More →"
                                        }, void 0, false, {
                                            fileName: "[project]/app/(pages)/blogs/BlogList.tsx",
                                            lineNumber: 229,
...
"[project]/node_modules/flowbite-react/dist/components/Select/theme.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const selectTheme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$flowbite$2d$react$2f$dist$2f$helpers$2f$create$2d$theme$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createTheme"])({
    base: "flex",
...
"[project]/node_modules/flowbite-react/dist/components/Select/Select.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$flowbite$2d$react$2f$dist$2f$components$2f$Select$2f$theme$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/flowbite-react/dist/components/Select/theme.js [app-ssr] (ecmascript)");
'use client';
;
;
;
...
;
;
const Select = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["forwardRef"])((props, ref)=>{
    ...
    const theme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$flowbite$2d$react$2f$dist$2f$helpers$2f$resolve$2d$theme$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useResolveTheme"])([
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$flowbite$2d$react$2f$dist$2f$components$2f$Select$2f$theme$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["selectTheme"],
        provider.theme?.select,
        props.theme
    ], [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$flowbite$2d$react$2f$dist$2f$helpers$2f$get$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["get"])(provider.clearTheme, "select"),
        props.clearTheme
    ], [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$flowbite$2d$react$2f$dist$2f$helpers$2f$get$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["get"])(provider.applyTheme, "select"),
        props.applyTheme
    ]);
    const { addon, className, color = "gray", icon: Icon, shadow, sizing = "md", ...restProps } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$flowbite$2d$react$2f$dist$2f$helpers$2f$resolve$2d$props$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resolveProps"])(props, provider.props?.select);
    return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxs"])("div", {
        ...
        children: [
            addon && /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])("span", {
            ...
            /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxs"])("div", {
                ...
                children: [
                    ...
                    /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])("select", {
                        ref,
                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$flowbite$2d$react$2f$dist$2f$helpers$2f$tailwind$2d$merge$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["twMerge"])(theme.field.select.base, theme.field.select.colors[color], theme.field.select.sizes[sizing], theme.field.select.withIcon[Icon ? "on" : "off"], theme.field.select.withAddon[addon ? "on" : "off"], theme.field.select.withShadow[shadow ? "on" : "off"]),
                        ...restProps
                    })
                ]
            })
...
//# sourceMappingURL=_9002bed3._.js.map