...
export default function Hero({ subHeading, heading, loading, ourLegacy, coreDifferentiars, onSchedule }: HeroProps) {
  ...
  const seoDescription =
    'Partner with Insonix to leverage top AI and Python developers for your projects. Schedule a consultation today.';
  ...
  return (
    <>
      ...
      <About ourLegacy={ourLegacy || {}} coreDifferentiars={coreDifferentiars} loading={loading} />
    </>
  );
}
