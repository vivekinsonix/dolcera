...
export default function BlogDetailClient({ initialBlog, slug, preview }: BlogDetailClientProps) {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 dark:bg-primary dark:text-white">
      ...
      <section className="mt-10 py-16 dark:bg-primary    dark:text-white" aria-labelledby="blog-title">
        <article className="container mx-auto max-w-7xl px-6 prose dark:prose-invert">
          <div className="mt-12 grid grid-cols-1 gap-10 md:grid-cols-12 lg:grid-cols-12 container mx-auto">
            <div className="md:col-span-9">
              ...
              {blog?.video?.[0]?.url && (
                <video src={blog.video[0].url} className="mt-10 w-full rounded-xl" autoPlay muted loop playsInline />
              )}
                    ...
                    <div key={index}>
                      {isPopular ? (
                        <div className="relative prose dark:prose-invert  flex scale-105 flex-col items-center rounded-2xl bg-gradient-to-b from-blue-600 to-blue-500 p-8 text-center text-white shadow-2xl transition-all hover:scale-110">
                          <span className="absolute top-4 right-4 rounded-full bg-white/20 px-2 py-1 text-xs">
                            {badge}
                          </span>
                        ...
                        <div className="relative flex flex-col items-center rounded-2xl bg-white p-8 text-center shadow-md transition-all hover:scale-110 hover:shadow-xl dark:bg-secondary-dark">
                          <span className="absolute top-4 right-4 rounded-full bg-blue-100 px-2 py-1 text-xs text-blue-600">
                            {badge}
                          </span>
