...
const Logo = () => (
  <div className="flex mt-2 justify-center">
    <Image src="/logo/insonix-light-logo-new.svg" width={130} height={40} className="dark:hidden" alt="Insonix" />
    <Image src="/logo/insonix-dark-logo.svg" width={130} height={40} className="hidden dark:block" alt="Insonix" />
  </div>
);
    ...
    >
      ...
      <section className="mb-6">
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          At Insonix, we use cookies and similar technologies to enhance your experience on our website, understand how
          visitors interact with our content, and support our security services.
          <br />
          <br />
          Cookies are small text files stored on your device that help websites remember preferences and improve user
          experience.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          We use cookies to ensure core functionality, analyze performance, personalize content, and improve user
          experience. Some cookies may be set by third-party services.
        </p>
      </section>
    </AppModal>
  );
